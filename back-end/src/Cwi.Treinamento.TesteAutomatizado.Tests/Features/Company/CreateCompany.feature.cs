...
namespace Cwi.Treinamento.TesteAutomatizado.Tests.Features.Company
{
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Empresa 1", "123", "300", null)]
        public virtual void CriacaoDeEmpresaComSucesso(string name, string code, string maxEmployeesNumber, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("Name", name);
            argumentsOfScenario.Add("Code", code);
            argumentsOfScenario.Add("MaxEmployeesNumber", maxEmployeesNumber);
...
#line hidden
#line 6
 testRunner.And("que seja feita uma chamada do tipo \'POST\' para o endpoint \'v1/companies\' com o co" +
                        "rpo da requisição", string.Format("\t{{\r\n\t  \"name\": \"{0}\",\r\n\t  \"code\": \"{1}\",\r\n\t  \"maxEmployeesNumber\": {2}\r\n\t}}", name, code, maxEmployeesNumber), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 14
 testRunner.Then("o código de retorno será \'201\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Entao ");
#line hidden
                ...
                table1.AddRow(new string[] {
                            ...
                            string.Format("{0}", maxEmployeesNumber),
                            "True"});
#line 15
