...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Validar valor unitário dos produtos")]
        ...
        public virtual void ValidarValorUnitarioDosProdutos(string productName, string price, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("ProductName", productName);
            argumentsOfScenario.Add("Price", price);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Validar valor unitário dos produtos", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 4
...
#line hidden
#line 10
 testRunner.Then(string.Format("tenho o produto {0} com o valor {1}", productName, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Entao ");
#line hidden
            }
